...
const VolunteerOpportunityCard = ({
  ...
  // const handleApplyClick = async () => {
  // setApplying(true);
  // await onApply(opportunity._id, coverLetter);
  // setApplying(false);
  // setShowModal(false);
  // setCoverLetter('');
  // };
      ...
      const result = await onApply(opportunity._id, coverLetter);
  ...
  shadow-[0_1px_4px_rgba(0,0,0,0.12)]"
      ...
      <div className="flex flex-col items-end justify-between">
        ...
        {hasApplied ? (
          <button
            disabled
            className="mt-6 px-5 py-2 bg-green-100 text-green-800
          ...
          <button
            ...
            className="mt-6 px-5 py-2 bg-[#FF7A30] text-white rounded-lg"
